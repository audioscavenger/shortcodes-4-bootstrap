...
# main config
PLUGINSLUG="shortcodes-4-bootstrap"
CURRENTDIR=`pwd`
MAINFILE="shortcodes-4-bootstrap.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/shortcodes-4-bootstrap" # Remote SVN repo on wordpress.org, with no trailing slash
